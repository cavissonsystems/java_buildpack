...
const DEFAULT_BACKUP_CONTROLLER=""
const DEFAULT_NDPROXY=""
...
If colNamedArguments.Exists("NDC") Then
  Ndc = colNamedArguments.Item("NDC")
Else
  Ndc = DEFAULT_NDC
End If
...
Function updateNDSettings()
  ...
  If objFSO.FolderExists(nddirPath) Then
	...
	call updateMapWithKeyword(SettingValueMap, "NDC_COMM_PROTOCOL", Ndc)
